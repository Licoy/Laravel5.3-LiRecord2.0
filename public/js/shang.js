(function($){
	...
	function write(){
		...
		+"    <h5>选择打赏方式：</h5>"
		+"    <div class=\"ds-payment-way\"><center>"
		...
		+ "       <img  class=\"qrcode-img qrCode_0\" id=\"qrCode_0\" src=\"//www.licoy.cn/wp-content/themes/begin/img/pay/weixinpay.png\" />"
		+ "      </div>"
		...
		+ "       <img  class=\"qrcode-img qrCode_1\" id=\"qrCode_1\" src=\"//www.licoy.cn/wp-content/themes/begin/img/pay/qqpay.png\" />"
		+ "      </div>"
		+ "      <p class=\"qrcode-tip\">打赏</p>"
		+ "     </div>"
		+ "     <div class=\"qrcode-img qrCode_2\" id=\"qrCode_2\">"
		+ "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(235, 95, 1\">"
		+ "       <img  class=\"qrcode-img qrCode_2\" id=\"qrCode_2\" src=\"//www.licoy.cn/wp-content/themes/begin/img/pay/alipay.png\" />"
		+ "      </div>"
		+ "      <p class=\"qrcode-tip\">打赏</p>"
		+ "     </div>"
		+ "    </div>"
